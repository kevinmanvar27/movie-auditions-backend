                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-6 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-theme-text">{{ $totalMovies }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-6 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-theme-text">{{ $totalAuditions }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-6 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-theme-text">{{ $successfulAuditions }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-theme-surface rounded-lg shadow border border-theme-border">
                ...
                <div class="p-4 md:p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <a href="{{ route('admin.movies.create') }}" class="flex flex-col items-center justify-center p-4 bg-theme-background rounded-lg border border-theme-border hover:bg-theme-secondary transition-colors">
                        ...
                        <a href="{{ route('admin.settings.index') }}" class="flex flex-col items-center justify-center p-4 bg-theme-background rounded-lg border border-theme-border hover:bg-theme-secondary transition-colors">
                            <div class="h-10 w-10 rounded-md bg-theme-primary flex items-center justify-center mb-2">
                                <svg class="h-5 w-5 text-theme-background" fill="none" stroke="currentColor" viewBox="0 0 24 24">
