            ...
            <form method="POST" action="{{ route('admin.movies.update', $movie->id) }}" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="genre" id="genre" class="input-field mt-1 block w-full" value="{{ old('genre', $movie->genre) }}" required>
                    </div>
                    
                    <div>
                        <label for="release_date" class="block text-sm font-medium text-theme-text">Release Date</label>
                        <input type="date" name="release_date" id="release_date" class="input-field mt-1 block w-full" value="{{ old('release_date', $movie->release_date->format('Y-m-d')) }}" required>
                    </div>
