...
@section('content')
    <div class="p-4 sm:p-6">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-theme-text">Create Page</h1>
            <p class="text-theme-text-secondary">Create a new dynamic page</p>
        </div>
            ...
            <form action="{{ route('admin.pages.store') }}" method="POST">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="slug" id="slug" class="input-field flex-1 block w-full rounded-none rounded-r-md" value="{{ old('slug') }}" placeholder="auto-generated-from-title">
                                </div>
                                <p class="mt-1 text-xs text-theme-text-secondary">Leave empty to auto-generate from title</p>
                                @error('slug')
                                    <p class="mt-1 text-sm text-theme-error">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="content" id="content" rows="15" class="input-field mt-1 block w-full">{{ old('content') }}</textarea>
                                @error('content')
                                    <p class="mt-1 text-sm text-theme-error">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="border border-theme-border rounded-lg p-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="order" id="order" class="input-field mt-1 block w-full" value="{{ old('order', 0) }}" min="0">
                                        <p class="mt-1 text-xs text-theme-text-secondary">Lower numbers appear first</p>
                                    </div>
                                    
                                    <div class="flex items-center">
                                        <input type="checkbox" name="show_in_menu" id="show_in_menu" value="1" class="rounded border-theme-border text-theme-primary focus:ring-theme-primary" {{ old('show_in_menu') ? 'checked' : '' }}>
                            ...
                            <div class="border border-theme-border rounded-lg p-4">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="meta_title" id="meta_title" class="input-field mt-1 block w-full" value="{{ old('meta_title') }}" maxlength="60">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="meta_description" id="meta_description" rows="3" class="input-field mt-1 block w-full" maxlength="160">{{ old('meta_description') }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="meta_keywords" id="meta_keywords" class="input-field mt-1 block w-full" value="{{ old('meta_keywords') }}">
                ...
                <div class="px-4 py-3 bg-theme-background border-t border-theme-border flex justify-end space-x-3">
                    ...
                    <button type="submit" class="btn btn-primary px-4 py-2" data-loading>
                        <span class="loading-text">Create Page</span>
