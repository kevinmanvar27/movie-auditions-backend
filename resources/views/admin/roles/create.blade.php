                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="border border-theme-border rounded-lg p-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" name="permissions[]" value="manage_notifications" class="rounded border-theme-border text-theme-primary focus:ring-theme-primary">
                                            <span class="ml-2 text-sm text-theme-text">Manage Notifications</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="permissions[]" value="manage_pages" class="rounded border-theme-border text-theme-primary focus:ring-theme-primary">
                                ...
                                <div class="border border-theme-border rounded-lg p-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" name="permissions[]" value="view_dashboard" class="rounded border-theme-border text-theme-primary focus:ring-theme-primary">
